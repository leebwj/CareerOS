...
| [`apps/tailor`](apps/tailor) | **Live** | Paste a job description → a one-page résumé **composed only from my real résumé blocks** + a fact-guarded cover letter, as ATS-clean docx/PDF — at [leebrian.dev/tailor](https://leebrian.dev/tailor) (passphrase-gated, docx built in the browser) or locally through the `apps/resume` Word pipeline |
