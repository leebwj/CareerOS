...
| [`apps/tailor`](apps/tailor) | **V1** | Paste a job description → a one-page résumé **composed only from my real résumé blocks** + a fact-guarded cover letter, rendered to ATS-clean docx/PDF through the same pipeline as `apps/resume` |
