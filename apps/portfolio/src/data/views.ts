...
export const views: View[] = [
  {
    ...
    order: ["passenger", "mini-minecraft", "wikipedia", "dewey", "path-at-penn", "penn-spark-redesign", "capsule", "art-of-web", "road-rogue", "playground"],
  ...
  },
  {
    ...
    order: ["dewey", "wikipedia", "path-at-penn", "penn-spark-redesign", "capsule", "art-of-web", "playground"],
