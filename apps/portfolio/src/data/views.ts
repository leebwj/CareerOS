...
export const views: View[] = [
  ...
  },
  {
    ...
    featured: ["mini-minecraft", "passenger", "mini-maya", "art-of-web"],
  ...
  },
  {
    ...
    order: ["mini-minecraft", "passenger", "mini-maya", "penn-spark-redesign", "art-of-web", "road-rogue", "capsule"],
    featured: ["mini-minecraft", "passenger", "mini-maya", "penn-spark-redesign"],
