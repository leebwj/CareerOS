...
export const views: View[] = [
  {
    ...
    order: ["mini-maya", "mini-minecraft", "wikipedia", "passenger", "dewey", "path-at-penn", "penn-spark-redesign", "art-of-web", "road-rogue", "capsule", "playground"],
    featured: ["mini-maya", "mini-minecraft", "wikipedia", "passenger"],
  ...
  },
  {
    ...
    order: ["mini-maya", "mini-minecraft", "passenger", "art-of-web", "road-rogue", "capsule", "playground"],
    featured: ["mini-maya", "mini-minecraft", "passenger", "art-of-web"],
  ...
  },
  {
    ...
    order: ["mini-maya", "mini-minecraft", "passenger", "penn-spark-redesign", "art-of-web", "road-rogue", "capsule"],
    featured: ["mini-maya", "mini-minecraft", "passenger", "penn-spark-redesign"],
