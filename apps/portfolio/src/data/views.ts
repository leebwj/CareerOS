...
export const views: View[] = [
  ...
  },
  {
    ...
    order: ["passenger", "mini-maya", "mini-minecraft", "art-of-web", "road-rogue", "capsule", "playground"],
    featured: ["passenger", "mini-maya", "mini-minecraft", "art-of-web"],
  ...
  },
  {
    ...
    order: ["passenger", "mini-maya", "mini-minecraft", "penn-spark-redesign", "art-of-web", "road-rogue", "capsule"],
    featured: ["passenger", "mini-maya", "mini-minecraft", "penn-spark-redesign"],
