...

  {
    ...
    blocks: [
      ...
      { type: "media", layout: "full", bare: true, items: [
        { src: mmDiagHe, alt: "Diagram: two faces sharing an edge, with one half-edge and its next, sym, vert and face pointers labelled", caption: "What one half-edge stores. A half-edge is one direction along one edge, owned by exactly one face. Walking next repeatedly circles that face and returns to where it started; sym is the twin in the face on the other side, running the opposite way; vert is the vertex it points at." },
      ] },
